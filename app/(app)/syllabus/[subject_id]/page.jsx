...
export default async function SyllabusSubjectPage({ params }) {
  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      {/* Header */}
      <div className="mb-6 mt-4 flex items-start justify-between gap-4 flex-wrap">
        <div>
        ...
        <Link
          href={`/syllabus/${subject_id}/coverage`}
          className="flex items-center gap-2 px-4 py-2 rounded-xl border border-border bg-surface text-sm font-medium text-navy hover:border-teal hover:text-teal transition-colors shrink-0"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
