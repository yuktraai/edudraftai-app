...
export function buildQuestionBankPrompt({
  ...
  return [
    {
      role: 'system',
      content: `You are an expert question-setter for SCTEVT Odisha diploma engineering examinations. Generate a professional question bank strictly following the SCTE&VT format.
...
Ensure questions span all listed subtopics proportionally and match SCTEVT difficulty standards.`,
    },
  ]
}
