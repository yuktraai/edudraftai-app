 ...
 */
export function buildLessonNotesPrompt({ topic, subtopics = [], subject_name, semester, difficulty = 'intermediate' }) {
  ...
  return [
    {
      role: 'system',
      content: `You are an expert educator creating structured lesson notes for diploma engineering students in Odisha following the SCTEVT curriculum. Your output must be strictly based on the provided topic and subtopics. Do not include content outside the given scope.
