...
STRICT OUTPUT RULE: Your ENTIRE response must be a single Mermaid.js code block.
Format EXACTLY as:
\`\`\`mermaid
[diagram code here]
\`\`\`
...
- Base content strictly on the topic and subtopics provided`,
    },
    {
      role: 'user',
      content: `Subject: ${subject_name}
Topic: ${topic}
${subtopics.length > 0 ? `Subtopics to represent: ${subtopics.join(', ')}` : ''}
